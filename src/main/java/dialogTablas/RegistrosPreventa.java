...
public class RegistrosPreventa extends javax.swing.JDialog {
	
	PreventaDelegate del = new PreventaDelegate();
	
	public int idPreventaForm;
	public int item;

	public RegistrosPreventa(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
		...
		idPreventaForm = Integer.parseInt(jTable1.getValueAt(registroSeleccionado, 0).toString());
	}
	...
	private void crearModeloDeTabla() {
		...
		String columnNames[] = { "idPreventa", "idVideojuego", "Anticipo", "idCliente"};
		DefaultTableModel modelo = new DefaultTableModel(columnNames, 0);

		for (Preventa consola : del.findAll()) {
			Object row[] = new Object[4];
			row[0] = consola.getIdPreventa();
			row[1] = consola.getIdVideojuego().getIdVideojuego();
			row[2] = consola.getAnticipo();
			row[3] = consola.getIdCliente().getIdCliente();
